...
/**
 * This class is a replacement for the standard StringTokenizer that
 * exposes the current position in the stream.
 *
...
public class StringTokenizer2 implements Enumeration {
     ...
     *                         as tokens.
     */
    public StringTokenizer2(String str, String delim, boolean returnTokens) {
	    currentPosition = 0;
	    this.str = str;
     ...
     * @see     StringTokenizer2#hasMoreTokens()
     */
     ...
     * @exception  NoSuchElementException  if there are no more tokens in this
     *               tokenizer's string.
     * @see        StringTokenizer2#nextToken()
     */
