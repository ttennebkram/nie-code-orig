...
/**
 * Description of the standard font Times-Roman
 * 
 * @author Steve Halliburton for NIE
 * @version 0.9
 */
public class PDFFontTimesRoman extends PDFFontDesc {

    public PDFFontTimesRoman() {
        ...
        fontDescriptor.put("CapHeight", new Float(662));
        ...
        fontWidths.put(new Integer(34), new Float(408));		// quotedbl
        ...
        fontWidths.put(new Integer(43), new Float(564));		// plus
        ...
        fontWidths.put(new Integer(60), new Float(564));		// less
        fontWidths.put(new Integer(61), new Float(564));		// equal
        fontWidths.put(new Integer(62), new Float(564));		// greater
        fontWidths.put(new Integer(63), new Float(444));		// question
        fontWidths.put(new Integer(64), new Float(921));		// at
        ...
        fontWidths.put(new Integer(70), new Float(556));		// F
        ...
        fontWidths.put(new Integer(74), new Float(389));		// J
        fontWidths.put(new Integer(75), new Float(722));		// K
        fontWidths.put(new Integer(76), new Float(611));		// L
        fontWidths.put(new Integer(77), new Float(889));		// M
        fontWidths.put(new Integer(78), new Float(722));		// N
        fontWidths.put(new Integer(79), new Float(722));		// O
        fontWidths.put(new Integer(80), new Float(556));		// P
        fontWidths.put(new Integer(81), new Float(722));		// Q
        fontWidths.put(new Integer(82), new Float(667));		// R
        ...
        fontWidths.put(new Integer(97), new Float(444));		// a
        ...
        fontWidths.put(new Integer(109), new Float(778));		// m
        ...
        fontWidths.put(new Integer(169), new Float(180));		// quotesingle
        fontWidths.put(new Integer(170), new Float(444));		// quotedblleft
        ...
        fontWidths.put(new Integer(182), new Float(453));		// paragraph
        fontWidths.put(new Integer(183), new Float(350));		// bullet
        fontWidths.put(new Integer(184), new Float(333));		// quotesinglbase
        fontWidths.put(new Integer(185), new Float(444));		// quotedblbase
        fontWidths.put(new Integer(186), new Float(444));		// quotedblright
        ...
        fontWidths.put(new Integer(191), new Float(444));		// questiondown
        ...
        fontWidths.put(new Integer(232), new Float(611));		// Lslash
        fontWidths.put(new Integer(233), new Float(722));		// Oslash
        fontWidths.put(new Integer(234), new Float(889));		// OE
