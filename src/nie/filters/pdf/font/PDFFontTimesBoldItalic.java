...
/**
 * Description of the standard font Times-BoldItalic
 * 
 * @author Steve Halliburton for NIE
 * @version 0.9
 */
public class PDFFontTimesBoldItalic extends PDFFontDesc {

    public PDFFontTimesBoldItalic() {
        ...
        fontDescriptor.put("CapHeight", new Float(669));
        fontDescriptor.put("Descent", new Float(-217));
        fontDescriptor.put("ItalicAngle", new Float(-15));
        ...
        fontWidths.put(new Integer(33), new Float(389));		// exclam
        ...
        fontWidths.put(new Integer(64), new Float(832));		// at
        ...
        fontWidths.put(new Integer(70), new Float(667));		// F
        ...
        fontWidths.put(new Integer(87), new Float(889));		// W
        fontWidths.put(new Integer(88), new Float(667));		// X
        fontWidths.put(new Integer(89), new Float(611));		// Y
        ...
        fontWidths.put(new Integer(94), new Float(570));		// asciicircum
        ...
        fontWidths.put(new Integer(123), new Float(348));		// braceleft
        fontWidths.put(new Integer(124), new Float(220));		// bar
        fontWidths.put(new Integer(125), new Float(348));		// braceright
        fontWidths.put(new Integer(126), new Float(570));		// asciitilde
        ...
        fontWidths.put(new Integer(182), new Float(500));		// paragraph
        ...
        fontWidths.put(new Integer(225), new Float(944));		// AE
        fontWidths.put(new Integer(227), new Float(266));		// ordfeminine
        ...
        fontWidths.put(new Integer(235), new Float(300));		// ordmasculine
