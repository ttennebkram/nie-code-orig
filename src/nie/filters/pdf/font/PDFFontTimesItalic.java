...
/**
 * Description of the standard font Times-Italic
 * 
 * @author Steve Halliburton for NIE
 * @version 0.9
 */
public class PDFFontTimesItalic extends PDFFontDesc {

    public PDFFontTimesItalic() {
        ...
        fontDescriptor.put("CapHeight", new Float(653));
        fontDescriptor.put("Descent", new Float(-217));
        fontDescriptor.put("ItalicAngle", new Float(-15.5));
        ...
        fontWidths.put(new Integer(34), new Float(420));		// quotedbl
        ...
        fontWidths.put(new Integer(43), new Float(675));		// plus
        ...
        fontWidths.put(new Integer(60), new Float(675));		// less
        fontWidths.put(new Integer(61), new Float(675));		// equal
        fontWidths.put(new Integer(62), new Float(675));		// greater
        fontWidths.put(new Integer(63), new Float(500));		// question
        fontWidths.put(new Integer(64), new Float(920));		// at
        fontWidths.put(new Integer(65), new Float(611));		// A
        fontWidths.put(new Integer(66), new Float(611));		// B
        fontWidths.put(new Integer(67), new Float(667));		// C
        fontWidths.put(new Integer(68), new Float(722));		// D
        fontWidths.put(new Integer(69), new Float(611));		// E
        fontWidths.put(new Integer(70), new Float(611));		// F
        fontWidths.put(new Integer(71), new Float(722));		// G
        fontWidths.put(new Integer(72), new Float(722));		// H
        fontWidths.put(new Integer(73), new Float(333));		// I
        fontWidths.put(new Integer(74), new Float(444));		// J
        ...
        fontWidths.put(new Integer(78), new Float(667));		// N
        fontWidths.put(new Integer(79), new Float(722));		// O
        fontWidths.put(new Integer(80), new Float(611));		// P
        fontWidths.put(new Integer(81), new Float(722));		// Q
        fontWidths.put(new Integer(82), new Float(611));		// R
        fontWidths.put(new Integer(83), new Float(500));		// S
        fontWidths.put(new Integer(84), new Float(556));		// T
        fontWidths.put(new Integer(85), new Float(722));		// U
        fontWidths.put(new Integer(86), new Float(611));		// V
        fontWidths.put(new Integer(87), new Float(833));		// W
        fontWidths.put(new Integer(88), new Float(611));		// X
        fontWidths.put(new Integer(89), new Float(556));		// Y
        fontWidths.put(new Integer(90), new Float(556));		// Z
        fontWidths.put(new Integer(91), new Float(389));		// bracketleft
        fontWidths.put(new Integer(92), new Float(278));		// backslash
        fontWidths.put(new Integer(93), new Float(389));		// bracketright
        fontWidths.put(new Integer(94), new Float(422));		// asciicircum
        ...
        fontWidths.put(new Integer(98), new Float(500));		// b
        fontWidths.put(new Integer(99), new Float(444));		// c
        fontWidths.put(new Integer(100), new Float(500));		// d
        ...
        fontWidths.put(new Integer(104), new Float(500));		// h
        fontWidths.put(new Integer(105), new Float(278));		// i
        fontWidths.put(new Integer(106), new Float(278));		// j
        fontWidths.put(new Integer(107), new Float(444));		// k
        fontWidths.put(new Integer(108), new Float(278));		// l
        fontWidths.put(new Integer(109), new Float(722));		// m
        fontWidths.put(new Integer(110), new Float(500));		// n
        fontWidths.put(new Integer(111), new Float(500));		// o
        fontWidths.put(new Integer(112), new Float(500));		// p
        fontWidths.put(new Integer(113), new Float(500));		// q
        fontWidths.put(new Integer(114), new Float(389));		// r
        fontWidths.put(new Integer(115), new Float(389));		// s
        fontWidths.put(new Integer(116), new Float(278));		// t
        fontWidths.put(new Integer(117), new Float(500));		// u
        fontWidths.put(new Integer(118), new Float(444));		// v
        fontWidths.put(new Integer(119), new Float(667));		// w
        fontWidths.put(new Integer(120), new Float(444));		// x
        fontWidths.put(new Integer(121), new Float(444));		// y
        fontWidths.put(new Integer(122), new Float(389));		// z
        fontWidths.put(new Integer(123), new Float(400));		// braceleft
        fontWidths.put(new Integer(124), new Float(275));		// bar
        fontWidths.put(new Integer(125), new Float(400));		// braceright
        fontWidths.put(new Integer(126), new Float(541));		// asciitilde
        fontWidths.put(new Integer(161), new Float(389));		// exclamdown
        ...
        fontWidths.put(new Integer(169), new Float(214));		// quotesingle
        fontWidths.put(new Integer(170), new Float(556));		// quotedblleft
        ...
        fontWidths.put(new Integer(182), new Float(523));		// paragraph
        fontWidths.put(new Integer(183), new Float(350));		// bullet
        fontWidths.put(new Integer(184), new Float(333));		// quotesinglbase
        fontWidths.put(new Integer(185), new Float(556));		// quotedblbase
        fontWidths.put(new Integer(186), new Float(556));		// quotedblright
        fontWidths.put(new Integer(187), new Float(500));		// guillemotright
        fontWidths.put(new Integer(188), new Float(889));		// ellipsis
        ...
        fontWidths.put(new Integer(208), new Float(889));		// emdash
        fontWidths.put(new Integer(225), new Float(889));		// AE
        fontWidths.put(new Integer(227), new Float(276));		// ordfeminine
        fontWidths.put(new Integer(232), new Float(556));		// Lslash
        fontWidths.put(new Integer(233), new Float(722));		// Oslash
        fontWidths.put(new Integer(234), new Float(944));		// OE
        fontWidths.put(new Integer(235), new Float(310));		// ordmasculine
        fontWidths.put(new Integer(241), new Float(667));		// ae
        ...
        fontWidths.put(new Integer(250), new Float(667));		// oe
        fontWidths.put(new Integer(251), new Float(500));		// germandbls
