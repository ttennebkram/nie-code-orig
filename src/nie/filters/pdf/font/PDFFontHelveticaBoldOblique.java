...
/**
 * Description of the standard fontH Helvetica-BoldOblique
 * 
 * @author Steve Halliburton for NIE
 * @version 0.9
 */
public class PDFFontHelveticaBoldOblique extends PDFFontDesc {

    public PDFFontHelveticaBoldOblique() {
        ...
        fontWidths.put(new Integer(34), new Float(474));		// quotedbl
        ...
        fontWidths.put(new Integer(38), new Float(722));		// ampersand
        fontWidths.put(new Integer(39), new Float(278));		// quoteright
        ...
        fontWidths.put(new Integer(63), new Float(611));		// question
        fontWidths.put(new Integer(64), new Float(975));		// at
        fontWidths.put(new Integer(65), new Float(722));		// A
        fontWidths.put(new Integer(66), new Float(722));		// B
        ...
        fontWidths.put(new Integer(74), new Float(556));		// J
        ...
        fontWidths.put(new Integer(94), new Float(584));		// asciicircum
        fontWidths.put(new Integer(95), new Float(556));		// underscore
        fontWidths.put(new Integer(96), new Float(278));		// quoteleft
        fontWidths.put(new Integer(97), new Float(556));		// a
        fontWidths.put(new Integer(98), new Float(611));		// b
        fontWidths.put(new Integer(99), new Float(556));		// c
        fontWidths.put(new Integer(100), new Float(611));		// d
        fontWidths.put(new Integer(101), new Float(556));		// e
        fontWidths.put(new Integer(102), new Float(333));		// f
        fontWidths.put(new Integer(103), new Float(611));		// g
        fontWidths.put(new Integer(104), new Float(611));		// h
        ...
        fontWidths.put(new Integer(109), new Float(889));		// m
        fontWidths.put(new Integer(110), new Float(611));		// n
        fontWidths.put(new Integer(111), new Float(611));		// o
        fontWidths.put(new Integer(112), new Float(611));		// p
        fontWidths.put(new Integer(113), new Float(611));		// q
        fontWidths.put(new Integer(114), new Float(389));		// r
        fontWidths.put(new Integer(115), new Float(556));		// s
        fontWidths.put(new Integer(116), new Float(333));		// t
        fontWidths.put(new Integer(117), new Float(611));		// u
        fontWidths.put(new Integer(118), new Float(556));		// v
        fontWidths.put(new Integer(119), new Float(778));		// w
        fontWidths.put(new Integer(120), new Float(556));		// x
        fontWidths.put(new Integer(121), new Float(556));		// y
        fontWidths.put(new Integer(122), new Float(500));		// z
        fontWidths.put(new Integer(123), new Float(389));		// braceleft
        fontWidths.put(new Integer(124), new Float(280));		// bar
        fontWidths.put(new Integer(125), new Float(389));		// braceright
        ...
        fontWidths.put(new Integer(169), new Float(238));		// quotesingle
        ...
        fontWidths.put(new Integer(174), new Float(611));		// fi
        fontWidths.put(new Integer(175), new Float(611));		// fl
        ...
        fontWidths.put(new Integer(182), new Float(556));		// paragraph
        fontWidths.put(new Integer(183), new Float(350));		// bullet
        fontWidths.put(new Integer(184), new Float(278));		// quotesinglbase
