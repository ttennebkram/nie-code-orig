 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class ManyHitsLinked3 extends BaseReport
{
	public String kClassName()
	{
		return "ManyHitsLinked3";
	}
			...
			throws ReportException
	{
		...
		try {
			...
			// this is for CLASSIC hyperlink style
			...
			while( ! atEndOfRecords )
			{
				...
				// Some calculations about the state of things
				//////////////////////////////////////////////////////
				...
				***/
				...
				// Add the Create / Edit Hyperlink or drop down actions
				...
				if( ! isNullSearch /*&& false*/ ) {
					...
					}	// End else does have user classes
	...
	public String getTitle( Hashtable inVars )
	{
		...
		return "Searches with Most Hits";
	}
