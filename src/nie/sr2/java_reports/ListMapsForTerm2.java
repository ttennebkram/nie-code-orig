 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class ListMapsForTerm2 extends BaseReport
{
	public String kClassName()
	{
		return "ListMapsForTerm2";
	}
			...
			throws ReportException
	{
		...
		try {
			...
			nie.webui.UILink _uiLink = null;
			try {
				_uiLink = new nie.webui.UILink(
					getMainConfig(),
			...
			nie.webui.UILink _uiLink2 = null;
			try {
				_uiLink2 = new nie.webui.UILink(
					getMainConfig(),
					// "CreateMapForm",							// String Screen Name
					UILink.CLASSIC_CREATE_MAP_UI_SCREEN,		// String Screen Name
			...
			***/
			...
			while( ! atEndOfRecords )
			{
				...
				Set existingAdClasses = DbMapRecord.static_getUserDataClassNamesForMap(
						getMainConfig(), mapID
						);
				...
				***/
				...
				String linkText2 = ReportConstants.VIEW_TEXT;
				String mode = nie.webui.UILink.UI_OPERATION_VIEW;
				...
				linkText2 = ReportConstants.EDIT_TEXT;
				mode = nie.webui.UILink.UI_OPERATION_EDIT;
