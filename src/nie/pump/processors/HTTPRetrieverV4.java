...
// statusMsg( kFName, "top of main loop" );
// TODO: fix xpump to allow debugging to be passed on command line
...
// statusMsg( kFName, "Interrupt" );
			...
			{
// statusMsg( kFName, "Exception: " + lException );
...
// statusMsg( kFName, "Mid loop" );
			...
			if( null != mWorkUnit )
			{
// statusMsg( kFName, "Work unit not null" );
...
// statusMsg( kFName, "NOT success" );
					...
					// TODO: revisit problem messages, we owe them an explanation
...
// statusMsg( kFName, "Success" );
			...
			{
// statusMsg( kFName, "Work unit IS NULL" );
...
// statusMsg( kFName, "Bottom of loop" );
...
// statusMsg( kFName, "About to fetch" );
...
// statusMsg( kFName, "Done with fetch, mDownloadedBytes=" + mDownloadedBytes );
...
// statusMsg( kFName, "Near bottom, getDoStatsOnly()=" + getDoStatsOnly() );

		if( getDoStatsOnly() && mDownloadedBytes > 0 )
			added++;
...
// statusMsg( kFName, "Done, added=" + added );
...
//		}
	...
	*************************************************/
	...
	boolean getDoStatsOnly() {
		return MODE_STATS.equalsIgnoreCase( getMode() );
	}
	...
	// TODO: tie these HTTP constants into the main code
