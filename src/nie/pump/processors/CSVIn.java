...
public class CSVIn extends Processor
{
	public String kClassName() { return "CSVIn"; }


	private void __sep__Constructor__() {}
	//////////////////////////////////////////////////////////////////

	public CSVIn( Application inApplication,
		  ...
		  )
	{
		...
		if( inParameters != null )
		{
			...
			catch (Exception e)
			{
				...
				fatalErrorMsg( kFName, "Shutting down (1) because of exception: " + e );
				System.exit(1);
			}
	...
	public void run()
	{
		...
		try {
			...
			fatalErrorMsg( kFName, "Shutting down (2) because of exception:" + e );
			System.exit( -1 );
		}
		...
		while( true )
		{
			...
			catch( Exception e )
			{
				...
				// System.err.println( e );
				// errorMsg( kFName, "Got Exception:" + e );
				stackTrace( kFName, e, "Got Exception while reading CSV record" );
				fatalErrorMsg( kFName, "Shutting down (3) because of exception: " + e );
				System.exit( -1 );
			}
...
//			return null;
		...
		if( loc == null || loc.trim().equals("") )
		{
			...
			// errorMsg( this, kFName, "location is a required attribute" );
	...
	****************************************************/
	...
	private WorkUnit parseCSVLine( String inputString )
	{
		...
		catch (Exception e)
		{
			...
			// System.err.println( e );
			// errorMsg( kFName, "Got Exception:" + e );
			stackTrace( kFName, e, "Got Exception parsing CSV line" );
			fatalErrorMsg( kFName, "Shutting down (5) due to exception: " + e );
			System.exit( 1 );
		}
	...
	****************************************************/
		...
		throws Exception
	{
		...
		if( buffer == null )
		{
			...
			debugMsg( kFName, "StreamTag:getNextRecord: end of file" );
			return null;
		}
