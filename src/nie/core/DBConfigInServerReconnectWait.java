...
public class DBConfigInServerReconnectWait extends Exception
{
	private static final String kClassName = "DBConfigInServerReconnectWait";

	public DBConfigInServerReconnectWait( String inMessage )
	{
		super( inMessage );
	...
	public DBConfigInServerReconnectWait( String inLocationTag, String inMessage )
	{
