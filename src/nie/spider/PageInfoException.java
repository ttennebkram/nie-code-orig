...
{
	private static final String kClassName = "PageInfoException";

	public PageInfoException( String inMessage )
	{
		super( inMessage );
	...
	public PageInfoException( String inLocationTag, String inMessage )
	{
