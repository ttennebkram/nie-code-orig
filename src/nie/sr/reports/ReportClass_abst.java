...
public class ReportClass_abst extends SRReport
{
    /************************************************************
    ...
    public ReportClass_abst( modelMain inModel )
    {
	super( inModel );
    }
    ...
    public String getReportTitle() { return "Most Popular Search Terms"; };
	...
	String retString = "<table border=0>\n" +
	    "	<tr>\n" +
	    "		" + formatReportLinkHeaderItem("Count", "center", "mps", "DESC") + "\n" +
