...
public class ReportClass_mpnsns extends SRReport
{
    /************************************************************
    ...
    public ReportClass_mpnsns( modelMain inModel )
    {
	super( inModel );
    }
    ...
    public String getReportTitle() { return "Most Popular NON Search Names Terms"; };
	...
	String retString = "<table border=0>\n" +
	    ...
	    "		" + formatReportLinkHeaderItem("Search Term", "left", "abnsn", "ASC" ) + "\n" +
