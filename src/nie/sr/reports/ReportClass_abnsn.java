...
public class ReportClass_abnsn extends SRReport
{
    /************************************************************
    ...
    public ReportClass_abnsn( modelMain inModel )
    {
		super( inModel );
    }
    ...
    public String getReportTitle() { return "Most Popular Non-SearchNames Terms"; };
	...
	String retString = "<table border=0>\n" +
	    "	<tr>\n" +
	    "		" + formatReportLinkHeaderItem("Count", "center", "mpnsns", "DESC") + "\n" +
